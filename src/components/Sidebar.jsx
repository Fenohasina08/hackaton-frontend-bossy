...
export default function Sidebar() {
  ...
  return (
    <>
      <nav className={`h-full glass flex flex-col border-r border-neutral-dark transition-all duration-300 ${isCollapsed ? 'w-20' : 'w-64'}`}>
        ...
        <div className="mt-auto p-4 border-t border-neutral-dark">
          <button
            ...
            className="flex items-center gap-3 p-4 mx-2 rounded-xl transition-all duration-300 text-neutral-light hover:bg-neutral-white/5 w-full"
          >
            <Settings size={20} />
      ...
      {/* Modal rendered outside the nav */}
